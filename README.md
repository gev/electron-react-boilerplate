...
```bash
git clone --depth=1 https://github.com/gev/electron-react-boilerplate.git your-project-name
```
...
```sh
git remote add upstream https://github.com/gev/electron-react-boilerplate.git
```
...
- [Evgeny Gazdovsly](https://github.com/gev)
